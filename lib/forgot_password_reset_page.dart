  ...
  void didChangeDependencies() {
    ...
    if (args != null) {
      if (args.containsKey('email')) {
        emailController.text = args['email']; // Pre-fill email if provided
      }
      if (args.containsKey('token')) {
        resetToken = args['token']; // Store reset token if provided
      }
    }
  }
      ...
      try {
        ...
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            "token": resetToken ?? "", // Ensure token is included if required
          }),
        );
